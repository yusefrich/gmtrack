          ...
          <ScrollView>
            ...
            <>
              <View style={{marginRight: 20, marginBottom: 10}}>
                <View style={styles.bgDetail}></View>
                <View style={{flex: 1, flexDirection: 'row', padding: 20}}>
                  <View style={{backgroundColor: COLORS.primary, padding: 5, borderRadius: 100}}>
                    <Image source={require('../assets/carroprofile.png')} style={[{width: 50, height: 50, resizeMode: 'contain'}, { tintColor: 'black' }]} />
                  </View>
                  <View style={{paddingLeft: 20}}>
                    <Text style={{color: 'white', fontWeight: '800'}}>{route.params.device.devicename}</Text>
                    <Text style={{color: COLORS.primary}}>{route.params.device.platenumber}</Text>
                  </View>
                </View>
              </View>
              <View style={{marginRight: 20, marginBottom: 10}}>
                ...
                <View style={{flex: 1, flexDirection: 'row', padding: 20, justifyContent: 'space-between'}}>
                  <Text style={{color: 'white', fontWeight: '800'}}>Placa</Text>
                  <Text style={{color: COLORS.primary}}>{route.params.device.platenumber}</Text>
                </View>
              </View>
              <View style={{marginRight: 20, marginBottom: 10}}>
                <View style={styles.bgDetailList}></View>
                <View style={{flex: 1, flexDirection: 'row', padding: 20, justifyContent: 'space-between'}}>
                  <Text style={{color: 'white', fontWeight: '800'}}>Modelo</Text>
              ...
              <View style={{marginRight: 20, marginBottom: 10}}>
                <View style={styles.bgDetailList}></View>
                <View style={{flex: 1, flexDirection: 'row', padding: 20, justifyContent: 'space-between'}}>
                  <Text style={{color: 'white', fontWeight: '800'}}>Ano</Text>
                  <Text style={{color: COLORS.primary}}></Text>
                </View>
              </View>
              <View style={{marginRight: 20, marginBottom: 10}}>
                <View style={styles.bgDetailList}></View>
                <View style={{flex: 1, flexDirection: 'row', padding: 20, justifyContent: 'space-between'}}>
                  <Text style={{color: 'white', fontWeight: '800'}}>Cor</Text>
                  <Text style={{color: COLORS.primary}}></Text>
                </View>
              </View>
              <View style={{marginRight: 20, marginBottom: 10}}>
                <View style={styles.bgDetailList}></View>
                <View style={{flex: 1, flexDirection: 'row', padding: 20, justifyContent: 'space-between'}}>
                  <Text style={{color: 'white', fontWeight: '800'}}>Renavam</Text>
                  <Text style={{color: COLORS.primary}}></Text>
                </View>
              </View>
            </>
